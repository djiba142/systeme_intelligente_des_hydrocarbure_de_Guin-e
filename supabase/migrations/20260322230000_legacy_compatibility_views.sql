-- ====================================================================
-- COMPATIBILITY LAYER: BRIDGE BETWEEN FRONTEND TYPES & NEW SCHEMA
...
-- Safety check: Ensure RLS is handled properly for views
-- Postgrest automatically respects underlying table RLS for views.
-- dossiers_entreprise and import_cargaisons ALREADY have RLS from previous migrations.

DO $$ 
BEGIN 
    RAISE NOTICE 'Compatibility views for importations and dossiers created successfully.';
